...
const TwoColSection : React.FC<TwoColSectionProps> = (props) => {
    return (
        <section className="w-11/12 flex flex-row gap-1.5rem items-center justify-between text-justify py-1.5rem">
            <div className="w-1/2 flex-1 flex items-center justify-start">
